...
inline auto FromString(std::string_view model_str) -> DeviceModel {
    if (model_str == "sst_cam_v1" || model_str == "sst-cam-v1" || model_str == "SST-CAM-V1" ||
        model_str == "SST_CAM_V1") {
        return DeviceModel::V1;
    }
    if (model_str == "sst_cam_v2" || model_str == "sst-cam-v2" || model_str == "SST-CAM-V2" ||
        model_str == "SST_CAM_V2") {
        return DeviceModel::V2;
    }
    if (model_str == "sst_cam_v3" || model_str == "sst-cam-v3" || model_str == "SST-CAM-V3" ||
        model_str == "SST_CAM_V3") {
        return DeviceModel::V3;
    }
    return DeviceModel::UNKNOWN;
}
inline auto ToString(DeviceModel model) -> std::string {
    switch (model) {
        case DeviceModel::V1:
            return "sst_cam_v1";
        case DeviceModel::V2:
